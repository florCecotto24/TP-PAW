...
/**
 * Notifies the car owner that a publication was paused because their profile has no identity document.
 * Use {@link #builder()} to construct instances.
 */
public final class CarPausedMissingIdentityOwnerEmailPayload {
    ...
    private CarPausedMissingIdentityOwnerEmailPayload(final Builder builder) {
    ...
    public static final class Builder {
        ...
        public CarPausedMissingIdentityOwnerEmailPayload build() {
            return new CarPausedMissingIdentityOwnerEmailPayload(this);
        }
    }
}
