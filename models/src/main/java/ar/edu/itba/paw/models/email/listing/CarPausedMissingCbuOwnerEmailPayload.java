 ...
 */
public final class CarPausedMissingCbuOwnerEmailPayload {
    ...
    private CarPausedMissingCbuOwnerEmailPayload(final Builder builder) {
    ...
    public static final class Builder {
        ...
        public CarPausedMissingCbuOwnerEmailPayload build() {
            return new CarPausedMissingCbuOwnerEmailPayload(this);
        }
    }
}
