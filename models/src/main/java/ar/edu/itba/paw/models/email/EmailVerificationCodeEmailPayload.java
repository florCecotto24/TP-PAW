...
/**
 * Account email verification code (sign-up / pending confirmation).
 * Use {@link #builder()} to construct instances.
 */
public final class EmailVerificationCodeEmailPayload {

    private final Locale messageLocale;
    private final String recipientEmail;
    private final String code;

    private EmailVerificationCodeEmailPayload(final Builder builder) {
    ...
    public static final class Builder {
        ...
        public EmailVerificationCodeEmailPayload build() {
            return new EmailVerificationCodeEmailPayload(this);
        }
    }
}
