 ...
 *
 * <p>All Java code that needs to reason about "what day / hour is it for our users" — listing
 ...
 * hard-coding the IANA tag again.</p>
 *
 * <p>Argentina does not observe DST, so a fixed {@link ZoneId} is safe and unambiguous.</p>
 *
 * <h2>Known duplications kept on purpose</h2>
 ...
 * <ul>
 *   <li><b>Flyway migration {@code V26__reservations_availabilities.sql}</b> — applied migrations
 ...
 *       must ship as a new migration, not as an edit of V26.</li>
 *   <li><b>{@code reservation-chat.js}</b> — a client-side {@code WALL_TIMEZONE} constant.
