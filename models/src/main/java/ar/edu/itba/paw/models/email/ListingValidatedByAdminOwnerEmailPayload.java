 ...
 */
public final class ListingValidatedByAdminOwnerEmailPayload {
    ...
    private ListingValidatedByAdminOwnerEmailPayload(final Builder builder) {
    ...
    public static final class Builder {
        ...
        public ListingValidatedByAdminOwnerEmailPayload build() {
            return new ListingValidatedByAdminOwnerEmailPayload(this);
        }
    }
}
