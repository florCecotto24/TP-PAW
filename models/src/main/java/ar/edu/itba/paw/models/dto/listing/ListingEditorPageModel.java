package ar.edu.itba.paw.models.dto.listing;
...
/**
 * Shared bundle consumed by both {@code listing/createListing.jsp} (publish flow) and
 * {@code listing/editAvailability.jsp} (per-availability edit flow) in {@code MyCarsController}.
 *
 * <p>Before {@code ListingEditorViewService} extracted this assembly, the two controller
 ...
 */
public final class ListingEditorPageModel {
