 ...
 */
public final class ListingPausedByAdminOwnerEmailPayload {
    ...
    private ListingPausedByAdminOwnerEmailPayload(final Builder builder) {
    ...
    public static final class Builder {
        ...
        public ListingPausedByAdminOwnerEmailPayload build() {
            return new ListingPausedByAdminOwnerEmailPayload(this);
        }
    }
}
