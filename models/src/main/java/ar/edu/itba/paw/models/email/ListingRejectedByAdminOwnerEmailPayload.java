 ...
 */
public final class ListingRejectedByAdminOwnerEmailPayload {
    ...
    private ListingRejectedByAdminOwnerEmailPayload(final Builder builder) {
    ...
    public static final class Builder {
        ...
        public ListingRejectedByAdminOwnerEmailPayload build() {
            return new ListingRejectedByAdminOwnerEmailPayload(this);
        }
    }
}
