 ...
 *
 * {@code birthDate} is the only nullable field; the rest are normalized by the service layer
 * (trim, optional blanking) and therefore accepted as raw strings here.
 */
