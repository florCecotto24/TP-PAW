...
public class UserJdbcDao implements UserDao {
    ...
    private static final String SELECT_COLUMNS =
            "id, email, forename, surname, email_validated, phone_number, birth_date, profile_picture_id";
    ...
    public User createUser(final String email, final String forename, final String surname, final String passwordHash) {
        ...
        return new User(userId.longValue(), normalizedEmail, forename, surname, passwordHash, Boolean.FALSE, null, null, null);
    }
    ...
    public Optional<User> getListingOwner(final long listingId) {
        return jdbcTemplate.query(
                "SELECT u.id, u.email, u.forename, u.surname, u.email_validated, u.phone_number, u.birth_date, u.profile_picture_id FROM users u "
