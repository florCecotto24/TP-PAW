...
public final class AppPaginationProperties {
    ...
    private static final String CAR_GALLERY_PAGE_SIZE = "app.pagination.car-gallery-page-size";
    private static final String MAX_PAGE_SIZE = "app.pagination.max-page-size";
    ...
    private static final int FALLBACK_CAR_GALLERY_PAGE_SIZE = 8;
    private static final int FALLBACK_MAX_PAGE_SIZE = 100;
    ...
    private final int carGalleryPageSize;
    ...
    public AppPaginationProperties(final Environment environment) {
        ...
        this.carGalleryPageSize = readPositiveInt(
                environment, CAR_GALLERY_PAGE_SIZE, FALLBACK_CAR_GALLERY_PAGE_SIZE);
        this.maxPageSize = readPositiveInt(environment, MAX_PAGE_SIZE, FALLBACK_MAX_PAGE_SIZE);
    }
    ...
    /** Car gallery list page size. */
    public int getCarGalleryPageSize() {
        return carGalleryPageSize;
    }

    /** Upper bound for {@code pageSize} query params (anti-abuse clamp). */
