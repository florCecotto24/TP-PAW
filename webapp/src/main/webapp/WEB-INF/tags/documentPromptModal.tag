...
<%@ attribute name="licenseInputId" required="false" rtexprvalue="true" %>
<%@ attribute name="identityInputId" required="false" rtexprvalue="true" %>
<%@ attribute name="licenseLabel" required="false" rtexprvalue="true" %>
<%@ attribute name="identityLabel" required="false" rtexprvalue="true" %>
...
<%@ attribute name="hideLicenseSlot" required="false" type="java.lang.Boolean"
              description="When true, omit the license row entirely (use when only identity is required)" %>
<%@ attribute name="hideIdentitySlot" required="false" type="java.lang.Boolean"
              description="When true, omit the identity row entirely (use when only license is required)" %>
...
<c:set var="renderLicenseSlot" value="${not (hideLicenseSlot eq true)}" />
<c:set var="renderIdentitySlot" value="${not (hideIdentitySlot eq true)}" />
