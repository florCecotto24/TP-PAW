                ...
                <div class="card-body p-4 p-md-5">
                    ...
                    <form:form action="${pageContext.request.contextPath}/publish-car"
                        ...
                        <div class="mb-3">
                            ...
                            <form:input path="ownerEmail" cssClass="form-control" cssErrorClass="form-control is-invalid" type="email" autocomplete="email"/>
                        ...
                        <div class="mb-3">
                            ...
                            <form:select cssClass="form-select" cssErrorClass="form-select is-invalid" path="type">
                        ...
                        <div class="mb-3">
                            ...
                            <form:select cssClass="form-select" cssErrorClass="form-select is-invalid" path="powertrain">
                        ...
                        <div class="mb-3">
                            ...
                            <form:select cssClass="form-select" cssErrorClass="form-select is-invalid" path="transmission">
                        ...
                        <div class="mb-3">
                            ...
                            <form:input path="pricePerDay" cssClass="form-control" cssErrorClass="form-control is-invalid"/>
                        ...
                        <div class="mb-4" id="publishAvailabilitySection">
                            ...
                            <button type="button" class="btn btn-outline-secondary btn-action btn-action-sm mt-1" id="publish_avail_add">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="d-flex flex-wrap align-items-center gap-2 mt-1">
                                ...
                                <label for="picturesInput" class="btn btn-outline-secondary btn-action btn-action-md mb-0"><spring:message code="publishCar.form.chooseFiles"/></label>
                            </div>
                        ...
                        <button type="submit" class="btn btn-primary btn-action btn-action-md">
