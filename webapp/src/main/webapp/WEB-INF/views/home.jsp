        ...
        <%@ taglib prefix="paw" tagdir="/WEB-INF/tags" %>
            ...
            <body>
                ...
                <div>
                    ...
                    <div class="sticky-top w-100 pt-4" style="top: 65px; z-index: 1020; background-color: #f9fbff;">
                        <paw:searchBar />
                    </div>
                    ...
                    <section class="cta-banner text-center text-white py-5 w-100" style="background-color: var(--color-primary, #3b7be0);">
                        <div class="container py-4 my-2">
                            ...
                            <paw:button href="${pageContext.request.contextPath}/" text="Publicar mi auto" size="lg" cssClass="btn-light text-primary fw-semibold px-4 rounded-3 shadow-sm" />
                        </div>
                    </section>
                </div>
