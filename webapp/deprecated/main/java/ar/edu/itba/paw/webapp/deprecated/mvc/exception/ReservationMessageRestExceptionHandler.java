...
import ar.edu.itba.paw.webapp.deprecated.mvc.controller.reservation.ReservationChatPollController;

import ar.edu.itba.paw.webapp.util.LocaleMessages;

/** JSON errors for reservation chat REST endpoints. */
@RestControllerAdvice(assignableTypes = {ReservationChatPollController.class})
