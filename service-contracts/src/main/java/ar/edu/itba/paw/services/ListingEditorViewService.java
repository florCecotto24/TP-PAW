...
/**
 * Builds the {@link ListingEditorPageModel} shared by both editor views in {@code MyCarsController}:
 * the publish flow ({@code listing/createListing.jsp}) and the per-availability edit flow
 * ({@code listing/editAvailability.jsp}).
 *
 ...
 */
public interface ListingEditorViewService {
     ...
     */
    ListingEditorPageModel loadEditorContext(Car car, long userId, LocalTime checkInTime);
}
