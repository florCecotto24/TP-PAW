...
/** Reads {@code app.listing.min-hours-between-checkin-checkout} to back {@link ListingCheckInOutPolicy}. */
@Component
public final class ListingCheckInOutPolicyImpl implements ListingCheckInOutPolicy {

    private final int minHoursBetweenCheckInAndCheckOut;

    @Autowired
    public ListingCheckInOutPolicyImpl(final Environment environment) {
