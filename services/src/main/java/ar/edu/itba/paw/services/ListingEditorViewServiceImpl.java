...
/**
 * Implementation of {@link ListingEditorViewService}. Centralises the orchestration of
 * {@link UserService} (publisher CBU + email), {@link LocationService} (neighborhoods),
 * {@link ListingAvailabilityService} (min / max wall-day window), {@link ReservationTimingPolicy}
 ...
 */
@Service
public final class ListingEditorViewServiceImpl implements ListingEditorViewService {
    ...
    @Autowired
    public ListingEditorViewServiceImpl(
    ...
    public ListingEditorPageModel loadEditorContext(
        ...
        return new ListingEditorPageModel(
                car,
                userHasCbu,
